  ...
  return (
    ...
    >
      <div className="space-y-6">
        {/* Current VIP Status */}
        <div className="text-center p-6 bg-gradient-to-r from-purple-600/20 to-blue-600/20 rounded-xl border border-purple-500/30">
          ...
          <div className="text-4xl font-bold text-purple-400 mb-2">{currentRakeback.rate}% Rakeback</div>
                ...
                <div className="grid grid-cols-7 gap-2 mb-4">
                  {dailyRewards.map((reward) => (
                    ...
                    >
                      ...
                      {reward.available && (
                        <Zap className="h-4 w-4 text-[#00d4ff] absolute -top-1 -right-1 animate-pulse" />
                      )}
                      <div className="text-lg font-bold text-white mb-1">Day {reward.day}</div>
                      <div className="text-xs text-gray-400 mb-1">{reward.reward}</div>
